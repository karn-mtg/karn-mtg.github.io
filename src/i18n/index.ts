...
const ui = {
  en: {
    ...
    downloadMacGatekeeperTitle: 'macOS security notice',
    downloadMacGatekeeperBody: 'Karn Forge is not yet notarized with Apple. After opening the DMG, right-click the app and choose Open — then confirm in the dialog. You only need to do this once.',
    // Footer
  ...
  'pt-br': {
    ...
    downloadMacGatekeeperTitle: 'Aviso de segurança no macOS',
    downloadMacGatekeeperBody: 'Karn Forge ainda não possui notarização da Apple. Após abrir o DMG, clique com o botão direito no app e escolha Abrir — depois confirme na janela. Você só precisa fazer isso uma vez.',
  ...
  de: {
    ...
    downloadMacGatekeeperTitle: 'macOS-Sicherheitshinweis',
    downloadMacGatekeeperBody: 'Karn Forge ist noch nicht bei Apple notarisiert. Öffne das DMG, klicke mit der rechten Maustaste auf die App und wähle Öffnen — dann bestätige im Dialog. Das musst du nur einmal tun.',
  ...
  es: {
    ...
    downloadMacGatekeeperTitle: 'Aviso de seguridad en macOS',
    downloadMacGatekeeperBody: 'Karn Forge aún no está notarizado con Apple. Tras abrir el DMG, haz clic derecho en la app y elige Abrir — luego confirma en el diálogo. Solo necesitas hacerlo una vez.',
